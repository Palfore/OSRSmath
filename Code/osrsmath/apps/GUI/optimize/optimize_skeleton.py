...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.frame, 15, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.progressBar, 14, 2, 1, 8)
        ...
        self.below_skill.addItem("")
        self.below_skill.addItem("")
        self.gridLayout.addWidget(self.below_skill, 7, 2, 1, 5)
        ...
        self.gridLayout.addWidget(self.best_in_slot_bonuses, 15, 6, 11, 4)
        ...
        self.gridLayout.addWidget(self.redose_level, 7, 8, 1, 2)
