from osrsmath.combat.fighter import Player
...
if __name__ == '__main__':
	...
	d = range(1000)
	a, d = np.meshgrid(a, d)
	A = np.vectorize(Player.get_accuracy)(a, d)
	...
	ax.plot(range(1000), range(1000), [Player.get_accuracy(x, x) for x in range(1000)], linewidth=2, c='black', zorder=3)
