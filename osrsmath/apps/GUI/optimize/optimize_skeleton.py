...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.prayer_attributes, 11, 5, 1, 3)
        ...
        self.gridLayout.addWidget(self.boosting_scheme, 6, 8, 1, 2)

        self.potions = QComboBox(Form)
        self.potions.setObjectName(u"potions")

        self.gridLayout.addWidget(self.potions, 6, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.potion_attributes, 6, 5, 1, 3)

        self.elite_void = QCheckBox(Form)
        self.elite_void.setObjectName(u"elite_void")
        self.elite_void.setChecked(True)

        self.gridLayout.addWidget(self.elite_void, 14, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.best_in_slot_bonuses, 17, 7, 11, 3)

        self.slayer_helm = QCheckBox(Form)
        self.slayer_helm.setObjectName(u"slayer_helm")
        self.slayer_helm.setChecked(True)

        self.gridLayout.addWidget(self.slayer_helm, 13, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.void_knight, 13, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.progressBar, 15, 1, 1, 9)
        ...
        self.gridLayout.addWidget(self.salve_amulet, 14, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.berserker_necklace, 14, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.spell, 5, 1, 1, 4)
