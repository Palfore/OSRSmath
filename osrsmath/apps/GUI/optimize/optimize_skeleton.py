...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.frame, 18, 0, 1, 7)
        ...
        self.gridLayout.addWidget(self.best_in_slot_bonuses, 18, 8, 11, 3)
        ...
        self.gridLayout.addWidget(self.progressBar, 15, 1, 1, 8)

        self.show_histogram = QCheckBox(Form)
        self.show_histogram.setObjectName(u"show_histogram")

        self.gridLayout.addWidget(self.show_histogram, 15, 9, 1, 1)
